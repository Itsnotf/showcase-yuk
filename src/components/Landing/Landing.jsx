...
function Landing() {
    ...
    return (
        <>
            <main className='flex md:flex-row flex-col-reverse w-full h-auto md:mx-8 md:mt-10 mt-5'>
                <div className='md:py-[75px] my-[10px] flex md:mx-14px w-[50%]  flex-col h-auto '>
                    <div className=' md:text-[50px] text-[25px] md:mt-0 mt-5 font-extrabold text-left w-screen'>
                        <h1 className=' dark:text-[#ffff] text-[#1B2430]'>Wasap Bro, <span className=' dark:text-[#9153F4] text-[#810CA8]'>Bingung
                            <br />Cari </span>Refrensi?</h1>
                        <p className=' dark:text-[#ffff] text-[#1B2430]  md:text-[20px] text-[12px] font-normal mt-[10px] md:mt-[22px]'>ShowcaseYuk, Menjadi Platform yang menyediakan <br />
                            tempat buat kita kita anak muda shearing serta <br />flexing project kita.</p>
                        <div onClick={Klikaku} className={Klik
